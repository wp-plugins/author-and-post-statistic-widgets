...
class APSW_Options {
    ...
    public function options_form() {
        ...
        <div class="wrap">
            ...
            <div style="float:left; width:40px; height:40px; margin:10px 10px 20px 0px;"><img src="<?php echo plugins_url(APSW_Core::$PLUGIN_DIRECTORY . '/files/img/plugin-icon/apsw-settings-icon.png'); ?>" style="width:40px;"/></div> <h2><?php _e('Author &amp; Post Statistic Widgets Settings', APSW_Core::$text_domain); ?></h2>
            <br style="clear:both" />
            ...
            <form action="<?php echo admin_url(); ?>admin.php?page=<?php echo $this->apsw_options_serialized->apsw_options_page_slug; ?>&updated=true" method="post" name="<?php echo $this->apsw_options_serialized->apsw_options_page_slug; ?>">               
                ...
                <div id="apswOptionsTabs">
                    <ul class="resp-tabs-list hor_1">
                        <li><?php _e('General', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('Active Users', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('Popular Posts', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('View counter for posts', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('Styles', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('Reset Statistics', APSW_Core::$text_domain); ?></li>
                        <li><?php _e('Support', APSW_Core::$text_domain); ?></li>
                    </ul>                   
                        ...
                        <tr valign="top">
                            <td>
                                <p class="submit">
                                    ...
                                    <a style="float: right;" class="button button-secondary" href="<?php echo admin_url(); ?>admin.php?page=<?php echo $this->apsw_options_serialized->apsw_options_page_slug; ?>&reset_options=1"><?php _e('Reset Options', APSW_Core::$text_domain); ?></a>
                                </p>
                            </td>
                        </tr>
                    </tbody>
