<div>
    <table class="form-table">
        <tbody>
            <tr valign="top">
                <th scope="row"><?php _e('Count post view by:', APSW_Core::$APSW_TEXT_DOMAIN); ?> </th>
                <td>
                    <fieldset>
                        <?php
                        ...
                        <label title="by ip">
                            ...
                            <span><?php _e('IP (for each day)', APSW_Core::$APSW_TEXT_DOMAIN); ?></span>
                        </label><br>
                        <label title="by page reload">
                            ...
                            <span><?php _e('Page Reload', APSW_Core::$APSW_TEXT_DOMAIN); ?></span>
                        </label><br>                                    
                    </fieldset>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><?php _e('Display posts\' daily views count', APSW_Core::$APSW_TEXT_DOMAIN); ?></th>
                <td>                                
