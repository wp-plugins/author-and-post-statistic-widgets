        ...
        <ul class="stats-popular-posts-list">
            ...
            foreach ($popular_posts as $popular_post) {
                ...
                <li class="stats-popular-post-list">
                    ...
                    <div class="stats-value stats-comments-count" title="<?php echo __('Post comments count', APSW_Core::$APSW_TEXT_DOMAIN); ?>">
                    ...
                    <div class="stats-value stats-views-count" title="<?php echo __('Post views count', APSW_Core::$APSW_TEXT_DOMAIN); ?>">
                        <img src="<?php echo plugins_url(APSW_Core::$PLUGIN_DIRECTORY . '/files/img/icon_views.png') ?>" title="<?php _e('views', APSW_Core::$APSW_TEXT_DOMAIN) ?>" alt="<?php _e('views', APSW_Core::$APSW_TEXT_DOMAIN) ?>" align="absmiddle" class="apsw-views-img" /><span class="apsw-views-num"><?php echo ($post_views_count) ? $post_views_count : 0; ?></span>
                        &nbsp;
                    </div>
