<div style="padding-bottom:10px;" id="allStatisticNSTab" class="stats_tabs">
    <ul class="css-tabs tabs-menu resp-tabs-list hor_1">
        <li><?php _e('Authors', APSW_Core::$APSW_TEXT_DOMAIN) ?></li>
                ...
                if ($this->apsw_options_serialized->is_author_popular_by_post_count == 1) {
                    ...
                    foreach ($authors_data as $author_data) {
                        ...
                        <li class="stats-author-posts-count">
                            ...
                            <span class="stats-value">                                
                                <?php echo $author_comments_count ?> <img src="<?php echo plugins_url(APSW_Core::$PLUGIN_DIRECTORY . '/files/img/icon_comments.png') ?>" title="<?php _e('comments', APSW_Core::$APSW_TEXT_DOMAIN) ?>" alt="<?php _e('comments', APSW_Core::$APSW_TEXT_DOMAIN) ?>" align="absmiddle" class="apsw-comments-img" />
                            </span>
                        </li>
                        <?php
                    }
