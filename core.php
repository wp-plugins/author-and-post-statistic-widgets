...
class APSW_Core {
    ...
    public function apsw_display_daily_views($content) {
		...
		$html .= '<div class="apsw_post_views_title"><img src="'. plugins_url('author-and-post-statistic-widgets/files/img/icon-stat.gif').'" align="absmiddle" class="apsw-stat-img-views_all" /> ' . __('Views All Time', APSW_Core::$text_domain) . '</div>';
        $html .= '<div class="apsw_post_views_value">' . $alltime_views . '</div>';
		$html .= '<div style="clear:both"></div>';
        $html .= '</div>';
        $html .= '<div class="apsw_views_daily">';
        $html .= '<div class="apsw_post_views_title"><img src="'. plugins_url('author-and-post-statistic-widgets/files/img/icon-stat-today.gif').'" align="absmiddle" class="apsw-stat-img-views_today" /> ' . __('Views Today', APSW_Core::$text_domain) . '</div>';
    ...
    public function init_widgets() {
        ...
        register_widget('APSW_Author_Widget');
    ...
    public function option_page_styles_scripts() {
        ...
        wp_register_style('jquery-ui-theme', plugins_url('author-and-post-statistic-widgets/files/css/jquery-ui-themes/themes/') . $this->apsw_options_serialized->active_theme_name . '/jquery-ui.min.css');
        ...
        wp_enqueue_script('apsw-widgets-js', plugins_url('author-and-post-statistic-widgets/files/js/widgets-js.js'), array('jquery'), '1.0.0', false);
    ...
    public function front_end_styles_scripts() {
        wp_register_style('sw-frontend-style', plugins_url('author-and-post-statistic-widgets/files/css/frontend-css.css'), null, get_option($this->apsw_version));
    ...
    public function add_plugin_options_page() {
        if (function_exists('add_options_page')) {
            add_menu_page('Statistic Widgets', 'Statistic Widgets', 'manage_options', 'stats_options', array(&$this->apsw_options, 'options_form'), plugins_url('author-and-post-statistic-widgets/files/img/plugin-icon/statistics-icon-20.png'), 4256);
        }
    }
