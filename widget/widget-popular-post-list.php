...
class APSW_Popular_Posts_List extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            ...
            'description' => __('This Widget displays popular posts list on all pages', APSW_Core::$APSW_TEXT_DOMAIN)
        );

        $control_ops = array();
        parent::__construct('popular_posts_list_widget', __('APSW - Popular Posts List', APSW_Core::$APSW_TEXT_DOMAIN), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        $defaults = array(
            'title' => __('Popular Posts List', APSW_Core::$APSW_TEXT_DOMAIN),
