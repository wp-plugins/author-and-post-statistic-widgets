...
<p>
    <label class="" for="<?php echo $this->get_field_id('author_widget_body_custom_args'); ?>"><?php _e('Use body custom before/after html:', Statistic_Info::$text_domain); ?></label>
    <input type="checkbox"                   
           class="checkbox before_body_chk"
           id="<?php echo $this->get_field_id('author_widget_body_custom_args'); ?>"
           name="<?php echo $this->get_field_name('author_widget_body_custom_args'); ?>"
           <?php checked($instance['author_widget_body_custom_args'] == 'on'); ?> />
</p>

<div style="display: <?php echo checked($instance['author_widget_body_custom_args'] == 'on') ? 'block' : 'none'; ?>;">
    <p>
