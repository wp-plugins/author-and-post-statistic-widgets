...
<p>
    <label class="" for="<?php echo $this->get_field_name('interval'); ?>"><?php _e('Select date interval:', APSW_Core::$APSW_TEXT_DOMAIN); ?></label>
    <select class="widefat apsw_date_interval" name="<?php echo $this->get_field_name('apsw_date_interval'); ?>">
        <option value="0" <?php selected($instance['apsw_date_interval'], '0'); ?>><?php _e('Today', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="1" <?php selected($instance['apsw_date_interval'], '1'); ?>><?php _e('Yesterday', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="7" <?php selected($instance['apsw_date_interval'], '7'); ?>><?php _e('Last 7 Days', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="30" <?php selected($instance['apsw_date_interval'], '30'); ?>><?php _e('Last 30 Days', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="90" <?php selected($instance['apsw_date_interval'], '90'); ?>><?php _e('Last 90 Days', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="365" <?php selected($instance['apsw_date_interval'], '365'); ?>><?php _e('Last 365 Days', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
        <option value="-1" <?php selected($instance['apsw_date_interval'], '-1'); ?>><?php _e('All Time', APSW_Core::$APSW_TEXT_DOMAIN); ?></option>
    </select>
</p>
